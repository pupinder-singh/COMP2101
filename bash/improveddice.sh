...
bias=1
range=6
dice1=$(( RANDOM % range + bias )) # Assign the rolled dice into the variable.
dice2=$(( RANDOM % range + bias ))
sum=$(( dice1 + dice2 )) # Prompting the dice's addition and assign it to sum.
average=$(( sum / 2 )) # Average of the dice is prompting here.
